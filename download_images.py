"""
::Multi-Threading live demo::
Here we download images from URLs mentioned in the list below.
Downloads happen in parallel and we use Multi-Threading for
the same.
...
def download_images(img_url):
    ...
    with open(img_name, "wb") as img_file:
        ...
        print(f"[INFO] {img_name} was downloaded...")
...
print(f"Total Time Taken : {round(t2-t1, 3)} second(s)")
